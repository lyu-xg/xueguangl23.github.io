...
$(function() {
  ...
  $(window).resize(function(){
	...
	function playDisc() {
      ...
      music.src = "../music/backgroundMusic.m4a";
  ...
  function checkOutProject() {
    $('.astronics-temp .btn').click(function() {
      $('section.experiences').css('z-index', 6);
      $('.astronics-detail').fadeIn();
    });
  }
